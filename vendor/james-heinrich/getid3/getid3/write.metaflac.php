	...
	public function WriteMetaFLAC() {
		...
		if (GETID3_OS_ISWINDOWS) {
			...
			if (file_exists(GETID3_HELPERAPPSDIR.'metaflac.exe')) {
				...
				$commandline  = 'cd /D ' . escapeshellarg(GETID3_HELPERAPPSDIR) . ' && metaflac.exe --no-utf8-convert --remove-all-tags --import-tags-from='.escapeshellarg($tempcommentsfilename);
